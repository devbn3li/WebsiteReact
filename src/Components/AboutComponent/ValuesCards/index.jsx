...
const Card = ({num, title, description,Class }) => (
  <div className={`${Class} relative border-[1px] border-l-[#1C4987]   p-6 bg-[#02c2ab]/30 hover:bg-[#02c2ab] duration-500 cursor-pointer hover:scale-105 rounded-lg shadow-md`}>
