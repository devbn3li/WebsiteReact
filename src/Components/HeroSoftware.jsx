  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 text-center">
        ...
        sustainability and  ESG Softwares
        </h1>
        <p className="mb-8 text-lg font-normal text-white/80 lg:text-xl  ">
          Unlock the full potential of your  sustainability and ESG initiatives with our innovative software solutions. From diagnostics to reporting and beyond, LevelUp offers tailored tools such as ESG Pulse, Sustainability Tracker, O2, and Data Lab.
        </p>
