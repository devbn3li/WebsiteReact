  ...
  return (
    <header className='mt-[4.5rem] w-full max-w-[1400px] px-[5%] pt-28 pb-8 flex justify-between'>
      <div className="w-[45%] gap-6 flex flex-col justify-center max-[570px]:w-full">
        <h1 className='text-[56px] font-bold leading-[1.2]'>LevelUp for Better Business & Planet.</h1>
        <p>Welcome to LevelUp, where we combine sustainability technology, science and human expertise to make a meaningful impact.</p>
