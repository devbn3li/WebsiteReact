...
const BenefitsCard = ({ icon, title, description, imageUrl, Class }) => {
  ...
  return (
    <div
      ...
      <div className={`${!imageUrl && 'hidden'} min-[479px]:mt-[7rem] md:mt-0  hover:scale-105 duration-700 cursor-pointer object-cover w-[80%] h-[250px] rounded-2xl overflow-hidden`}>
