    ...
    <section className="bg-white rounded-3xl ">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <div className="w-full flex justify-center">
          <h1 className="mb-4 text-2xl max-w-[1000px] font-extrabold tracking-tight leading-none text-gray-900 md:text-3xl lg:text-4xl ">
            {title}
          </h1>
        </div>
        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-42 ">
          {subtitle}
        </p>
      </div>
    </section>
