...
const SubNavbarLink_V3 = ({ Icon, title, path, clear }) => {
  ...
  return (
    <Link to={path} className={`active:scale-90 group flex justify-between items-center gap-2 rounded-lg font-semibold p-3 transition-all group/subLink bg-[#02c2ab]/70 hover:bg-[#112b65] w-full`} onClick={clear}>
