...
const SubNavbarLink_V2 = ({ Icon, title, path, clear, color }) => {
  ...
  return (
    <Link to={path} className={`group flex justify-start items-center gap-2 font-semibold p-3 pl-0 group/subLink ${color ? `text-[${color}]` : 'text-[#112b65]'} hover:text-[#121212] text-sm`} onClick={clear}>
      ...
      bg-[#168996] text-[#168996]
      bg-[#112b65] text-[#112b65]
      ' />
    </Link>
  );
