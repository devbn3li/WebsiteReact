...
const SubNavbarLink = ({ Icon, title, path, clear, className='' }) => {
  return (
    <Link to={path} className={`flex justify-center items-center gap-2 font-semibold p-3 group/subLink hover:text-[#121212] text-[#02c2ab] text-sm ${className}`} onClick={clear}>
