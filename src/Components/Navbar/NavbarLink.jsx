...
const NavbarLink = ({ path, title }) => {
  ...
  const linkClasses = 'px-4 py-2 hover:bg-[#e6e6e5] hover:font-bold rounded-lg transition-all duration-[.45s] inline-block max-[991px]:hover:bg-transparent max-[991px]:px-0 max-[991px]:py-3';
  return (
