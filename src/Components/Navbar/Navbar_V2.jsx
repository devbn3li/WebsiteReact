      ...
      <div className='flex gap-5 justify-between items-center px-[5%] max-[1130px]:px-0 max-w-[1400px] box-border w-full bg-white h-[4.5rem]'>
        ...
        <div className='z-50  max-[1130px]:w-full max-[1130px]:flex max-[1130px]:p-[5%] max-[1130px]:h-full justify-between items-center'>
          <Link to='/' className='flex gap-[6px] items-center'>
            <img className='aspect-square w-[48px]' src={LogoImage} alt='LevelUp logo' />
            <span className='text-[25px] font-bold max-[1130px]:inline-block max-[1245px]:hidden inline-block text-[#333]'>Level<span className='text-black'>Up</span></span>
          </Link>
          <button className='hidden max-[1130px]:flex flex-col aspect-square w-12 justify-center items-center gap-[6px]' onClick={toggleNavigation}>
