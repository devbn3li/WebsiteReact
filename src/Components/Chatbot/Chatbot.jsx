      ...
      <section className="bg-gradient-to-r from-[#002e70] to-[#02c1aa] w-full rounded-2xl py-[5rem] max-sm:py-8">
        <div className="relative w-[90%] md:w-[80%] mx-auto flex justify-center items-center flex-col py-[4rem] pt-[6rem] px-2rem text-white">
         ...
         The 2024 Global Internal Audit Standards
          ...
          <p className="my-6 mt-4 md:w-[70%] text-center text-white text-xl leading-[1.7] aos-init aos-animate">
          ...
          <form onSubmit={handleFormSubmit} className="relative  flex items-center mb-10">
            <input
              ...
              type="text"
              placeholder="Ask Me!"
              className="input-placeholder shadow-2xl max-[400px]:w-[300px] w-[300px] sm:w-[400px] md:w-[500px] py-3 px-4 rounded-[5rem] outline-none text-white text-xl bg-white/30 backdrop-blur-lg border-2 border-gray-200/50"
              value={inputText}
