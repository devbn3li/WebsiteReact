                ...
                <div className="relative w-[90%] md:w-[80%] mx-auto flex justify-center items-center flex-col py-[4rem] pt-[6rem] px-2rem text-[#002E70]">
                    ...
                    >
                        <input
                            ...
                            type="text"
                            placeholder="Ask Me!"
                            className={`input-placeholder shadow-2xl duration-500 ${inputText ? "!border-[#002E70]" : ""
                    ...
                    <div
                        className={`relative border-[#002E70]/30 max-[400px]:w-[330px] w-[350px] sm:w-[500px] md:w-[700px] h-[350px] bg-white/30 p-4 rounded-xl outline-none text-[#002E70] text-xl overflow-auto backdrop-blur-lg border-2 ${isLoading ? "border-[#002E70]" : ""
                            }`}
                    >
                        {isLoading ? (
