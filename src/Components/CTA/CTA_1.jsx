...
const CTA1 = ({ path }) => {
  return (
    <div className='w-[90%] bg-gradient-to-r from-[#112b65] to-[#02c2ab]  max-w-[1400px] rounded-3xl flex max-[1000px]:flex-col justify-center gap-28 p-24 max-[500px]:px-6 py-6 items-center   box-border overflow-hidden my-16'>
      <div className='max-w-[300px] max-[340px]:hidden max-h-[350px] rounded-t-full overflow-hidden'>
        <img
          src={CTA}
          alt='demo'
