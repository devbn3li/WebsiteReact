...
const TerminalIcon = () => (
  ...
  >
    <path
      d="M12 14H18V16H12V14ZM6.29303 9.70697L8.58603 12L6.29303 14.293L7.70703 15.707L11.414 12L7.70703 8.29297L6.29303 9.70697Z"
      fill="currentColor"
    ></path>
    <path
...
const Benefits = () => {
  ...
  const sectionDescription =
    "The benefits of using LevelUp O2 for measuring GHG emissions include";

  // Define the benefits fetched from a source or defined statically
  const benefits = [
    {
      icon: <TerminalIcon />,
      title: "Comprehensive Emissions Footprint Management",
      description:
        "LevelUp O2 provides a complete solution for managing a company's emissions footprint by calculating Scope 1, 2, and 3 greenhouse gas emissions",
    },
    {
      icon: <RocketIcon />,
      title: "Emissions Reduction and Target Setting",
      description:
        "The platform allows companies to visualise their emissions footprint by Scope 1, 2, and 3, enabling them to identify high-emission operational areas and set ESG targets based on forward-looking strategies for emissions reduction",
    },
    {
      icon: <LeafIcon />,
      title: "Audit-Ready Data for Reporting",
      description:
        "Companies can export audit-ready 14 emissions data for reporting to investors, supply chain, regulators,stakeholders, and common ESG frameworks such as GRI, CDP, SASB, TCFB, and ISSB",
    },
  ];
