            ...
            <div className="ring-1 ring-gray-700/20 rounded-3xl p-8 xl:p-10">
              ...
              >
                ...
                <li className="flex gap-x-3">
                  ...
                  Ensuring Data Integrity in ESG Reporting: Procedures and
                  Checklist
                </li>
                <li className="flex gap-x-3">
                  <svg
            ...
            <div className="bg-white/5 ring-2 ring-[#02c2ab] rounded-3xl p-8 xl:p-10">
              ...
              >
                <li className="flex gap-x-3">
                  ...
                  ESG Infrastructure: Templates and Procedures for All
                  Departments
                </li>
                <li className="flex gap-x-3">
                  <svg
                ...
                <li className="flex gap-x-3">
                  ...
                  Strategic ESG Integration: Guidelines for Committees and
                  Boards
                </li>
                <li className="flex gap-x-3">
                  <svg
            ...
            <div className="ring-1 ring-gray-700/20 rounded-3xl p-8 xl:p-10">
              ...
              >
                <li className="flex gap-x-3">
                  ...
                  Personalized 1:1 sessions with a senior advisor.{" "}
                </li>
                <li className="flex gap-x-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <li className="flex gap-x-3">
                  ...
                  Comprehensive quarterly reviews and strategic planning
                  sessions.
                </li>
                <li className="flex gap-x-3">
                  <svg
