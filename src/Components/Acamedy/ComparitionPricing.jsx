...
function ComparitionPricing() {
  return (
    <div><section className="text-gray-700 body-font overflow-hidden border-t border-gray-200">
    <div className="container px-5 py-24 mx-auto flex flex-wrap">
      <div className="lg:w-1/4 mt-48 hidden lg:block">
        <div className="mt-px border-t border-gray-300 border-b border-l rounded-tl-lg rounded-bl-lg overflow-hidden">
          <p className="bg-gray-100 text-gray-900 h-12 text-left px-4 flex items-center justify-start -mt-px">
      ...
      <div className="flex lg:w-3/4 w-full flex-wrap lg:border border-gray-300 rounded-lg">
        <div className="lg:w-1/3 lg:mt-px w-full mb-10 lg:mb-0 border-2 border-gray-300 lg:border-none rounded-lg lg:rounded-none">
          <div className="px-2 text-left h-48 flex flex-col items-center justify-center">
            <h3 className="tracking-widest">plan</h3>
          ...
          <div className="border-t border-gray-300 p-6 text-left rounded-bl-lg">
            <button className="flex items-center mt-auto text-center text-white bg-[#02c2ab] border-0 py-2 px-4 w-full focus:outline-none hover:bg-indigo-600 rounded">
                <Link to="/waitinglist">Start Now</Link>
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
...
export default ComparitionPricing