...
const PrimaryBtn = ({ path, title, classes = '' }) => {  // provided a default value for classes to avoid undefined errors
  ...
  const btnClasses = `rounded-[2.5rem] bg-[#02c2ab] border border-[#02c2ab] transition-all duration-[.45s] py-2 px-5 hover:shadow-[0_4px_16px_rgba(0,0,0,.2)] hover:-translate-y-1 inline-block text-white ${classes}`;
