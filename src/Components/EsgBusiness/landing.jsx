    ...
    <section className="my-18 w-full">
      <div className="container pt-32 pb-20 mx-auto px-[5%] md:h-[800px] overflow-hidden bg-gradient-to-b from-[#112b65] to-[#02c2ab] rounded-b-[40px]">
        <div className="flex flex-col justify-center items-center text-center">
          <h2
            className="text-4xl  md:w-[50%] font-extrabold text-white"
            data-aos="fade-down"
          ...
          >
            ...
            with Our GRC Services
          </h2>
          <p
            className="my-12 md:w-[80%] text-white text-xl "
            data-aos="fade-up"
            data-aos-duration="1200"
          >
            Empower resilience and growth with our comprehensive GRC and business transformation services. 
          </p>
          <div
