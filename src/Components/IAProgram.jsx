  ...
  return (
    <section className='py-[4rem]'>
        <div className='w-[80%] mx-auto mb-5'>
            <h1 className='uppercase text-2xl md:text-4xl font-semibold text-center'>key components of IA Audit program</h1>   
        </div>
                ...
                <div>
                    <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-5 '> 
                        <div className=''>
                            ...
                            <h2 className='text-[#002E70] uppercase text-2xl font-[600] tracking-[.5px] mb-5 mt-10 lg:mt-0'>governance</h2>
                            {
                        ...
                        <div className=''>
                            ...
                            <h2 className='text-[#002E70] uppercase text-2xl font-[600] tracking-[.5px] mb-5 mt-10 lg:mt-0'>planning</h2>
                            {
                        ...
                        <div className=''>
                            ...
                            <h2 className='text-[#002E70] uppercase text-2xl font-[600] tracking-[.5px] mb-5 mt-10 lg:mt-0'>Execution & reporting</h2>
                            {
