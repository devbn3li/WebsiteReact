...
function Popup({ isOpen, closeModal }) {
  return (
    < >
    <Modal className='w-full max-w-[1400px]   absolute bottom-2  bg-black rounded-2xl outline-none '  isOpen={isOpen} onRequestClose={closeModal} contentLabel="Example Modal">
