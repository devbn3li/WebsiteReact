...
function Popup({ isOpen, closeModal }) {
  return (
    < >
    <Modal className='w-[95%] max-w-[900px] absolute bottom-10 bg-black rounded-2xl outline-none left-1/2 -translate-x-1/2 '  isOpen={isOpen} onRequestClose={closeModal} contentLabel="Example Modal">
