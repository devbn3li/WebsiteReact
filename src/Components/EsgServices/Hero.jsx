...
const Hero = () => {
  ...
  const headerTitle = "ESG Excellence Unlocked";
  const headerDescription =
    "Empower your ESG journey with tailored diagnostics, strategy, and compliance solutions for sustainable business excellence.";
      ...
      <div className="w-[45%] gap-6 flex flex-col justify-center max-[570px]:w-full">
        ...
        <div className="font-bold gap-4 flex flex-wrap max-[570px]:flex-col">
          ...
          <PrimaryBtn
            ...
            classes="bg-[#e6e6e5] !text-[#121212] border-[#e6e6e5] px-6 py-3"
          />
        </div>
      </div>
