    ...
    <div className="py-12 ">
      <div className="max-w-[1400px] mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl leading-8 max-w-[580px] inline-block box-border font-extrabold tracking-tight text-gray-900 sm:text-4xl">
