  ...
  return (
    <div className="flex flex-col p-4  max-w-sm aspect-square hover:scale-95 hover:bg-[#02c2ab]/20 rounded-xl transition-all duration-500 cursor-pointer">
      <img
        src={imageUrl}
        alt={title}
        className="mb-4 w-full aspect-square bg-gradient-to-r hover:bg-gradient-to-b hover:scale-95  duration-500  from-[#112b65] to-[#02c2ab] object-contain rounded-lg shadow-lg"
      />
    ...
    <div className="py-12 ">
      ...
      >
        <div className="text-center mb-12">
          <h2 className="text-3xl leading-8 max-w-[580px] inline-block box-border font-extrabold tracking-tight text-[#002e70] sm:text-4xl">
            ...
            <span className="relative inline-block w-[80px] mx-2">
              ...
              <svg
                className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-[75%] w-full h-12 z-10"
        ...
        <div           data-aos="fade-up"
          data-aos-duration="1600" className="flex flex-wrap text-[#002e70] justify-center gap-10">
