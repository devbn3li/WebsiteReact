    ...
    <section className=" rounded-b-3xl " >
          <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <div className='w-full flex justify-center'>
              <h1 className="mb-4 text-4xl max-w-[1000px] font-extrabold tracking-tight leading-none  md:text-5xl lg:text-6xl ">
                {props.title}
              </h1>
            </div>
            <p className="mb-8 text-lg font-normal  lg:text-xl sm:px-16 xl:px-48 ">{props.discription}</p>
          </div>
        </section>
  )
}
