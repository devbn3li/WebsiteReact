...
import challengeImg from "/assets/undraw-tasks.png";
    ...
    benefits: [
      {
        ...
        description: "LevelUp O2 provides a complete solution for managing a company's emissions footprint by calculating Scope 1, 2, and 3 greenhouse gas emissions",
      },
      {
        icon: <RocketIcon />,
        title: "Emissions Reduction and Target Setting",
        description: "The platform allows companies to visualise their emissions footprint by Scope 1, 2, and 3, enabling them to identify high-emission operational areas and set ESG targets based on forward-looking strategies for emissions reduction",
      },
      {
        icon: <LeafIcon />,
