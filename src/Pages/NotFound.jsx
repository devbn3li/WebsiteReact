...
const NotFound = () => {
  return (
    <div className='w-full h-full min-h-[400px]'>
      <main className="h-[800px] w-full flex flex-col justify-center items-center ">
  ...
  <button className="mt-5">
    <a className="relative inline-block text-sm font-medium text-white group active:text-[#02c2ab] focus:outline-none focus:ring">
