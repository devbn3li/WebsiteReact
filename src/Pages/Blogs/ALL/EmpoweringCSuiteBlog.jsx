...
const Body = () => (
  <div className='flex flex-col gap-4'>
    ...
    <p>
      By empowering the C-suite with the necessary knowledge, skills, and alignment, businesses can forge a path towards sustainable success. Together, they can overcome challenges, seize opportunities, and drive positive change for a better future.
    </p>

    <Quote text="At Levelup, we are committed to supporting C-suite leaders in their sustainability endeavors. Our program will provide them with the necessary knowledge, skills, and alignment to navigate the complexities of sustainability and drive sustainable success. Together, we can create a better future for our businesses, communities, and the planet." />
  </div>
);

const EmpoweringCSuiteBlog = () => {
  return (
    <div className='w-full flex justify-center'>
      <div className='flex flex-col  box-border px-[5%] items-center mt-[4.5rem] text-[#121212] max-w-[1400px]'>
        ...
        <div className='overflow-hidden rounded-xl mb-24 border-2 aspect-[2/1] '>
...
export default EmpoweringCSuiteBlog;
