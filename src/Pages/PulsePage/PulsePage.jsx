...
const PulsePage = () => {
  ...
  return (
    <div className='flex justify-center items-center flex-col'>
      ...
      {/* CTA Card */}
      <div className='w-screen max-w-[1400px] mx-[5%] rounded-3xl flex max-[1000px]:flex-col justify-center gap-28 p-24 max-[500px]:px-6 py-6 items-center bg-[#02c2ab] box-border overflow-hidden my-16'>
