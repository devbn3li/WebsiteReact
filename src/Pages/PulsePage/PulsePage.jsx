...
const PulsePage = () => {
  const heroData = {
    ...
    description: "Accelerate your business growth and sustainability impact with AI-powered ESG assessments",
    CTATitle: "Learn More",
    CTAPath: "/contact"
  }
  ...
  const benefitsData = {
    ...
    description: 'Harness the power of AI for a strategic, comprehensive approach to sustainability that\'s tailored to your industry and needs:',
    benefits: [
      {
        icon: <FaBrain />,
        title: "AI-Driven Insights",
        description: "Unlock precise, AI-powered ESG assessments for rapid and accurate insights, enabling smarter sustainability decisions.",
      },
      {
        icon: <FaUniversalAccess />,
        title: "Versatile and Tailored",
        description: "Whether you're in manufacturing, tech, or services, our platform adapts to your sector, delivering customized, actionable guidance.",
      },
      {
        icon: <FaChartLine />,
        title: "Strategic Benchmarking",
        description: "Empower your strategy with benchmarking against global standards and competitors, identifying clear paths for improvement and growth.",
      }
    ]
  };
  ...
  return (
    <div className='flex justify-center items-center flex-col'>
      ...
      {/* Start about section ====================================== */}
      <div className='bg-[#121212] py-12 md:py-20 text-white w-full flex flex-col justify-center items-center'>
