  ...
  return (
    <div className="mt-[7em]  flex justify-center">
      <div className="max-w-[1000px] px-3">
        <div className="container mx-auto px-4 py-8 text-[#002e70]">
          <h1 className="text-3xl font-bold mb-4">Privacy Notice</h1>

          <p className="mb-4">Last updated January 25, 2024</p>

          <p className="mb-4">
            This privacy notice for LevelUp ESG Ltd. (doing business as LevelUp)
          ...
          <p className="mb-4">
            ...
            <a href="https://levelupesg.co/" target="_blank" rel="noreferrer">
              https://levelupesg.co/
            </a>
          ...
          <p className="mb-4">
            ...
            <a href="mailto:info@levelupesg.co">info@levelupesg.co</a>.
          </p>
          ...
          <p className="mb-4">
            This privacy notice is subject to change. We encourage you to review
          ...
          <p className="mb-4">
            We collect information based on your interactions with our services,
          ...
          <p className="mb-4">
            We process information for service provision, improvement,security,
          ...
          <p className="mb-4">
            We share information in specific situations and with specific third
            parties.
          </p>
          <h2 className="text-2xl font-bold mb-2">
          ...
          <p className="mb-4">
            We have organizational and technical measures in place. However, no
            system is 100% secure.
          </p>

          <h2 className="text-2xl font-bold mb-2">What are your rights?</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            https://levelupesg.co/Talk2us, or by contacting us. We will consider
          ...
          <p className="mb-4">Review the privacy notice in full.</p>
          ...
          <p className="mb-4">Personal information you disclose to us</p>
          ...
          <h2 className="text-2xl font-bold mb-2">Sensitive Information</h2>
          ...
          <p className="mb-4">
            ...
            than thirty-six (36) months past the termination of the user&apos;s
            account.
          </p>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-bold mb-2">Withdrawing Your Consent</h2>
          <p className="mb-4">
            ...
            preferences. However, please note that this will not affect the
          ...
          <p className="mb-4">
            ...
            us at info@levelupesg.co or contact us by post at: LevelUp ESG Ltd.
            160 City Road Kemp House London EC1V 2NP England
          </p>
          <h2 className="text-2xl font-bold mb-2">
            DO WE MAKE UPDATES TO THIS NOTICE?
          </h2>
          ...
          <p className="mb-4">
            ...
            https://levelupesg.co/ or Talk2us.
          </p>
