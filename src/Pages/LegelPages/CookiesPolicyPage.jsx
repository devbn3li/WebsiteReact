      ...
      <div className="mt-[7em]  flex justify-center">
        <div className="max-w-[1000px] px-3">
          <div className="container mx-auto px-4 py-8 text-[#002e70]">
            ...
            <p className="mb-4">
              This Cookie Policy outlines the practices of LevelUp regarding the
              use of cookies on our website and services. By using LevelUp, you
            ...
            <p className="mb-4">
              ...
              mobile device by websites that you visit. They are widely used to
            ...
            <p className="mb-4">
              At LevelUp, we use cookies to understand how you use our site and
              to improve your experience. This includes personalizing content,
              providing social media features, and analyzing our traffic. We may
            ...
            <p className="mb-4">
              ...
              they are deleted or expire. The cookies we use can be categorized
              into the following types:
            </p>

            <p className="mb-4">
              Essential Cookies: These cookies are necessary for the website to
              function and cannot be switched off. They are usually only set in
              ...
              filling in forms. This policy provides detailed information about
              how we use cookies on our website and services. As a UK-based
              company, we adhere to the Privacy and Electronic Communications
              Regulations (PECR) alongside the UK General Data Protection
              Regulation (UK GDPR).
            </p>
            ...
            <h2 className="text-2xl font-bold mb-2">Why We Use Cookies</h2>
            <p className="mb-4">
            ...
            <ol>
              ...
              <li>
                Providing targeted content and advertising that may be of
            ...
            <ol>
              ...
              <li>
                Performance Cookies: These allow us to count visits and traffic
                sources, helping us to measure and improve the performance of
                our site.
              </li>
              <li>
                Functionality Cookies: These enable the website to provide
                enhanced functionality and personalization.
              </li>
              <li>
                Targeting Cookies: These may be set through our site by our
            ...
            <p className="mb-4">
              ...
              technologies, please email us at info@levelupesg.co.
            </p>

            <p className="mb-4">
              By using the LevelUp website and services, you consent to the use
